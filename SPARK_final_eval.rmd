...
First we set our working directory to the path with the data (not a local file--we cannot store )
...
hs_spark_1<-read_xlsx("SPARK 2017 HN.xlsx", sheet = 7, header = FALSE)
